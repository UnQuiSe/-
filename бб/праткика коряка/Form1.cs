...
namespace праткика_коряка
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            SqlDataAdapter drug = new SqlDataAdapter(SqlText, @"Data Source=ANNA;Initial Catalog=afrodisiac;Integrated Security=True");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            pictureBox1.Image = Image.FromFile("C:/Users/Анна/Desktop/проекты/ИСП-301/Белобородов/испр/12/5.gif");
        }
